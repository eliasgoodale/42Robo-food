...
def build_graph(observations):
    ...
    return logits
        ...
        all_act_prob = tf.nn.softmax(logits, name='act_prob')  # use softmax to convert to probability
...
def main(args):
    ...
    with tf.Graph().as_default() as g:
        ...
        with tf.Session(graph=g) as sess:
            ...
            # DO INSIDE OF ENV MANAGER CLASS
                while True:
